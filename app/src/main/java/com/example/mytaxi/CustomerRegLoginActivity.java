            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    if (mAuth.getCurrentUser().isEmailVerified()) {
                        ...
                        loadingBar.dismiss();
                        Intent driverIntent = new Intent(CustomerRegLoginActivity.this, CustomersMapActivity.class);
                        startActivity(driverIntent);
                    } else {
                        Toast.makeText(CustomerRegLoginActivity.this, "Пожалуйста пройдите верификацию на вашей почте", Toast.LENGTH_SHORT).show();
                        loadingBar.dismiss();
                    }
                } else {
                    ...
                    mAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(CustomerRegLoginActivity.this, "Регистрация прошла успешно, проверьте свою почту для верификации",
