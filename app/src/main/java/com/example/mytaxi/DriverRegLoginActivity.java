            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    if (mAuth.getCurrentUser().isEmailVerified()) {
                        ...
                        Toast.makeText(DriverRegLoginActivity.this, "Пожалуйста пройдите верификацию на вашей почте", Toast.LENGTH_SHORT).show();
                        loadingBar.dismiss();
                    }
                } else {
                    Toast.makeText(DriverRegLoginActivity.this, "Пожалуйста пройдите верификацию на вашей почте", Toast.LENGTH_SHORT).show();
                            ...
                            mAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(DriverRegLoginActivity.this, "Регистрация прошла успешно, проверьте свою почту для верификации",
