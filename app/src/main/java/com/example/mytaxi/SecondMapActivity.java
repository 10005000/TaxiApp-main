...
//        }
//        else {
//            address2 = getIntent().getExtras().get("address").toString();
//        };
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener(){
            ...
            public void onMapClick(final LatLng latLng) {
                mMap.addMarker(new MarkerOptions().position(new LatLng(0, 0)).title("Я здесь").icon(BitmapDescriptorFactory.fromResource(R.drawable.close)));
                CameraUpdate update = CameraUpdateFactory.newLatLngZoom(latLng, 16);
                mMap.animateCamera(update);

                Geocoder geocoder = new Geocoder(SecondMapActivity.this, Locale.getDefault());
                try {
                    ...
                    if (addresses != null) {
                        ...
                        saveAddressBtn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                productMap.put("address2", address);
                                productMap.put("lat2", lat);
                                productMap.put("lon2", lon);
                                ...
                                RootRef.child("Customers").child("Orders").child(CustomerId).updateChildren(productMap)
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task)
                                            {
                                                ...
                                                {
                                                    Intent intent = new Intent(SecondMapActivity.this, CustomersMapActivity.class);
                                                ...
                                                else
                                                {
                                                    ...
                                                    Toast.makeText(SecondMapActivity.this, "Ошибка:  " + message, Toast.LENGTH_SHORT).show();
                                                }
                                            }
                                        });
                            }
    ...
    protected void onStart() {
        super.onStart();
        AlertDialog.Builder builder = new AlertDialog.Builder(SecondMapActivity.this, R.style.AlertDialog);
        builder.setTitle("Отметьте точку на карте, куда Вас привезти.");
